...
const Dot:FC<IDot> = ({color, show=true,small=false}) =>{
  ...
  return <div className={cl(styles.value__dot, 
...
export const InfoValue: FC<IInfoValueProps> = ({ label, value, color,isActiveTooltip,lastElementTooltipStyle=false }) => {
  ...
  return (
    <div className={styles.value}>
      ...
      <div className={cl(styles.value__content,isActiveTooltip && styles.value__content_isActiveTooltip)}>
